...
--Group Functions: Count() ,Max() ,Min() ,Sum() ,AVG()
...
-- Q3: Show full name ,salary   and hire date whos  Hired from 1998 and salary more than 6000 then sorting
