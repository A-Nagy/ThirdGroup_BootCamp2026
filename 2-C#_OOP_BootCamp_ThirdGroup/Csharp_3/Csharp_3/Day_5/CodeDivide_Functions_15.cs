...
namespace Csharp_3.Day_5
{
     class CodeDivide_Functions_15
    {
        ...
        static void CpanlStringDisplay() 
        {
        ...
        static void EmployeeSystemInfo() 
        {
            Console.WriteLine("===============================");
        ...
        static void PatientBMICalculator() 
        {
            Console.WriteLine("===============================");
